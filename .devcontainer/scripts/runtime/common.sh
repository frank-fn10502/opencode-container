...
OPENCODE_DEV_CONFIG_DIR="${DEVCONTAINER_DIR}/config"
PROFILE_SOURCE_DIR="${DEVCONTAINER_DIR}/profile"
...
USER_PROFILE_README_SOURCE="${PROFILE_SOURCE_DIR}/profile-dockerfile-guide.md"
PROJECT_PROFILE_README_SOURCE="${PROFILE_SOURCE_DIR}/project-profile-readme.md"
USER_PROFILE_TEMPLATE_DIR="${PROFILE_SOURCE_DIR}/user-profiles"
